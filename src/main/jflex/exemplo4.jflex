...
"("             { return new Token(yyline + 1, yycolumn + 1, Classe.cParEsq); }
")"             { return new Token(yyline + 1, yycolumn + 1, Classe.cParDir); }
"+"             { return new Token(yyline + 1, yycolumn + 1, Classe.cAdicao); }
"-"             { return new Token(yyline + 1, yycolumn + 1, Classe.cSubtracao); }
"*"             { return new Token(yyline + 1, yycolumn + 1, Classe.cMultiplicacao); }
"/"             { return new Token(yyline + 1, yycolumn + 1, Classe.cDivisao); }
":="            { return new Token(yyline + 1, yycolumn + 1, Classe.cAtribuicao); }
"."             { return new Token(yyline + 1, yycolumn + 1, Classe.cPonto); }
","             { return new Token(yyline + 1, yycolumn + 1, Classe.cVirgula); }
";"             { return new Token(yyline + 1, yycolumn + 1, Classe.cPontoVirgula); }
":"             { return new Token(yyline + 1, yycolumn + 1, Classe.cDoisPontos); }
"<>"            { return new Token(yyline + 1, yycolumn + 1, Classe.cDiferente); }
">="            { return new Token(yyline + 1, yycolumn + 1, Classe.cMaiorIgual); }
"<="            { return new Token(yyline + 1, yycolumn + 1, Classe.cMenorIgual); }
">"             { return new Token(yyline + 1, yycolumn + 1, Classe.cMaior); }
